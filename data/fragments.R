## some scripts for various tasks
...
## 9. clean up regions boundary data
## 10. update summaries elements x regions
## 11. make mock regional summaries tab
## 12. find bird results & add birds tab (use static if necessary)
## 13. find bou results & add bou tab (use static if necessary)
## 14. update landing page & navigation
## 15. put together methods tab w static images
